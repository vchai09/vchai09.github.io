...
# In this case keep just the reported variables
vardesc <- vardesc %>%
  filter(Source == "2014-2020 data shared by CDC; some 2014 variables and 2020 Maine data supplemented from CDC website PDFs") %>%
  select(-c(Formula,`Decision Maker Takeaway`,Source,Availability))
